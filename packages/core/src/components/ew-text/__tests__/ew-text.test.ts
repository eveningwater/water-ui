...
describe('EwText', () => {
  ...
  describe('文本类型', () => {
    it('应该支持 primary 类型', async () => {
      ...
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--primary')).toBeTruthy();
    });

    it('应该支持 success 类型', async () => {
      text.setAttribute('type', 'success');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--success')).toBeTruthy();
    });

    it('应该支持 warning 类型', async () => {
      text.setAttribute('type', 'warning');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--warning')).toBeTruthy();
    });

    it('应该支持 danger 类型', async () => {
      text.setAttribute('type', 'danger');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--danger')).toBeTruthy();
    });

    it('应该支持 info 类型', async () => {
      text.setAttribute('type', 'info');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--info')).toBeTruthy();
    });
  });
  ...
  describe('文本大小', () => {
    it('应该支持 large 大小', async () => {
      ...
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--large')).toBeTruthy();
    });

    it('应该支持 default 大小（默认）', async () => {
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--default')).toBeFalsy();
    });

    it('应该支持 small 大小', async () => {
      text.setAttribute('size', 'small');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--small')).toBeTruthy();
    });
  });
  ...
  describe('文本截断', () => {
    it('应该支持 truncated 属性', async () => {
      ...
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--truncate')).toBeTruthy();
    });

    it('应该支持 line-clamp 属性', async () => {
      text.setAttribute('line-clamp', '2');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--line-clamp-2')).toBeTruthy();
    });

    it('应该支持 line-clamp 1', async () => {
      text.setAttribute('line-clamp', '1');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--line-clamp-1')).toBeTruthy();
    });

    it('应该支持 line-clamp 3', async () => {
      text.setAttribute('line-clamp', '3');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--line-clamp-3')).toBeTruthy();
    });
  });
  ...
  describe('文本对齐', () => {
    it('应该支持 left 对齐', async () => {
      ...
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--left')).toBeTruthy();
    });

    it('应该支持 center 对齐', async () => {
      text.setAttribute('align', 'center');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--center')).toBeTruthy();
    });

    it('应该支持 right 对齐', async () => {
      text.setAttribute('align', 'right');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--right')).toBeTruthy();
    });
  });
  ...
  describe('文本粗细', () => {
    it('应该支持 bold 粗细', async () => {
      ...
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--bold')).toBeTruthy();
    });

    it('应该支持 normal 粗细', async () => {
      text.setAttribute('weight', 'normal');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--normal')).toBeTruthy();
    });

    it('应该支持 light 粗细', async () => {
      text.setAttribute('weight', 'light');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--light')).toBeTruthy();
    });
  });
  ...
  describe('文本样式', () => {
    it('应该支持 italic 样式', async () => {
      ...
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--italic')).toBeTruthy();
    });

    it('应该支持 underline 样式', async () => {
      text.setAttribute('style', 'underline');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--underline')).toBeTruthy();
    });

    it('应该支持 line-through 样式', async () => {
      text.setAttribute('style', 'line-through');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--line-through')).toBeTruthy();
    });
  });
  ...
  describe('状态', () => {
    it('应该支持 disabled 状态', async () => {
      ...
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--disabled')).toBeTruthy();
    });

    it('应该支持 clickable 状态', async () => {
      text.setAttribute('clickable', '');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--clickable')).toBeTruthy();
    });

    it('应该支持 responsive 状态', async () => {
      text.setAttribute('responsive', '');
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--responsive')).toBeTruthy();
    });
  });
  ...
  describe('属性监听', () => {
    it('应该监听属性变化', async () => {
      ...
      await new Promise(resolve => setTimeout(resolve, 10));
      expect(text.shadowRoot?.querySelector('.ew-text--danger')).toBeTruthy();
      expect(text.shadowRoot?.querySelector('.ew-text--primary')).toBeFalsy();
    });
  });
}); 